...
def train_loop(dataloader, model, loss_fn, optimizer, image_processor=None):
    ...
    for batch, (imgs, texts) in enumerate(dataloader):
        ...
        if train_acc == 1:
            if loss < best_loss:
                torch.save(model.state_dict(), '/scratch1/yuqiuwan/CSCI567/ctranspath_clip_mask_currentBest.pt')
...
torch.save(clip_model.state_dict(), '/scratch1/yuqiuwan/CSCI567/ctranspath_clip_mask.pt')
